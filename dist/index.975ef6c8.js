...
function onSearch() {
    ...
    const fetchQuery = (0, _fetchCountriesDefault.default)(searchQuery);
    fetchQuery.then((data)=>{
        ...
        fetchQuery.then((data)=>{
            if (data.length === 1) {
                data.map((e)=>list.insertAdjacentHTML("beforeend", `<img src="${e.flags.png}" alt="${e.flags.alt}" width="350px">
            <div>
                ...
                fetchQuery.then((data)=>data.map((e)=>list.insertAdjacentHTML("beforeend", `<div>
              <li class="js-li">
    ...
    }).catch((error)=>(0, _pnotifyJs.alert)({
...
},{"./sass/main.scss":"dFl68","./js/fetchCountries":"dKuy9","lodash.debounce":"3JP5n","../node_modules/@pnotify/core/dist/PNotify.js":"9RSjy","../node_modules/@pnotify/mobile/dist/PNotifyMobile.js":"a8oTw","@pnotify/core/dist/Material.css":"adIQv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dFl68":[function() {},{}],"dKuy9":[function(require,module,exports) {
...
},{}],"adIQv":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire8972")
